...
const Lesson4 = () => {
          ...
          <div className="px-40 flex flex-1 justify-center py-5">
            <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
              ...
              <p className="text-white text-base font-normal leading-normal pb-3 pt-1 px-4">
                Puedes pensar en una variable como una caja con nombre que
                guarda un valor para poder usarlo más adelante. Sirve para
                guardar información como números, palabras o resultados, y ese
              ...
              <p className="text-white text-base font-normal leading-normal pb-3 pt-1 px-4">
                ...
                Más tarde puedes usar esa variable para mostrar la edad,
                comprarla o cambiarla.
              </p>
	...
	print(“Juan tiene”, edad, “años y es estudiante de”, carrera)`}
              ...
              <>llllllllllllllllllllllllllllPPPPPPPPPPPP</>
              ...
              <p className="text-white text-base font-normal leading-normal pb-3 pt-1 px-4">
                ...
                <br />
                Además de esta convención, hay otras sencillas reglas que
                debemos seguir para nombrar a las variables:
              </p>
              <ol className="ml-8">
...
`}
              ...
              <p className="text-white text-base font-normal leading-normal pb-3 pt-1 px-4">
                En este caso, a pesar de quese sigue la convención snake_case,
                el nombre es demasiado largo y poco específico. Puede generar
                confusión sobre si realmente estamos hablando del nombre del
                curso o de algún otro atributo relacionado con el colegio.{" "}
                <br />
              ...
              <p className="text-white text-base font-normal leading-normal pb-3 pt-1 px-4">
                ...
                asegurarse de que los datos están en el formato adecuado para
                una operación o comparación.
                <br />
                ...
                ejemplo int(), float(), str() etc. A continuación veremos
                algunos ejemplos de cómo aplicar esta técnica:
              </p>
...
`}
                ...
                - Decimales con int(): Cuando conviertes un número decimal
                (float) a entero, Python eliminará la parte decimal sin
                redondear. Es decir, realiza un corte hacia abajo:
                <br />
                <div className="console-container">
                  <div className="console-box">
                    <SyntaxHighlighter language="python" style={monokai}>
...
`}
              ...
              <p className="text-white text-base font-normal leading-normal pb-3 pt-1 px-4">
                En programación, cada valor que asignemos a una variable tiene
                un tipo. Esto le dice a la computadora qué clase de información
                está guardando. A continuación te presentamos los tipos de datos
                más comunes que podemos encontrar en python
              </p>
...
`}
              ...
              <p className="text-white text-base font-normal leading-normal pb-3 pt-1 px-4">
                Como puedes ver, estamos usando una función nueva llamada
                type().
                <br />
                Esta función nos dice qué tipo de dato tiene una variable. Para
                usarla, colocamos el nombre de la variable entre paréntesis,
                como en type(nombre).
              ...
              <p className="text-white text-base font-normal leading-normal pb-3 pt-1 px-4">
                ...
                <br />
                - Los valores de tipo int (números enteros) no llevan comillas.
                Si escribes "18" entre comillas, Python lo toma como texto, no
                como número.
                <br />
                - Para los valores de tipo float (números con decimales), se
                debe usar el punto como separador decimal.
                <br />- Los valores de tipo bool (booleanos) deben escribirse
                con la primera letra en mayúscula: True o False
              </p>
              ...
              <div className="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3">
                <label className="flex flex-col min-w-40 flex-1">
                  <input
                    ...
                    className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl text-white focus:outline-0 focus:ring-0 border border-[#2f396a] bg-[#181d35] focus:border-[#2f396a] h-14 placeholder:text-[#8e99cc] p-[15px] text-base font-normal leading-normal"
                    value=""
                  />
                </label>
              </div>
