...
const CodeEditor: React.FC<CodeEditorProps> = ({
  ...
  const [theme, setTheme] = useState<any>(githubDark); // Puede ser cualquiera de los temas
  const [language, setLanguage] = useState<any>(javascript); // Puede ser javascript o python
